            ...
            >
              ...
              >
                <Typography
                  ...
                  sx={{ color: "#B28011" }}
                >
                  Connectez-vous avec DevHubProjects et donnez vie à vos
                  projets.
                </Typography>
              </Stack>
              <Divider orientation="vertical" variant="middle" flexItem />
              ...
              >
                ...
                <Typography variant="body1" color="text.secondary">
                  ...
                  de suivre l'avancement des tâches, de gérer les ressources et
                  de communiquer efficacement. Grâce à cette application, les
                  membres de l'équipe peuvent facilement collaborer et rester
                  synchronisés sur les différentes étapes du projet. De plus,
                  l'application permet de visualiser les dépendances entre les
                  tâches et de planifier les ressources en fonction des besoins.
                  En somme, une application de gestion de projet est un outil
                  indispensable pour tout projet réussi.
                </Typography>
              </Stack>
            </Stack>
          </Box>
